...
<body>
    ...
    ?>
    <form method="post" action="delete.php" onsubmit="return validate();" name="f1">
        <div class="div1"><b>收件箱</b>(共<?php echo $reccount; ?>封)</div>
        <div class="div2">
            <div class="div2-1">
                <input type="submit" name="delete" id="delete" value="删除">
                <input type="button" name="refresh" id="refresh" value="刷新" onclick="window.open('receiveemail.php','_self');">
            </div>
            <div class="div2-2">
                <?php
                    if($pagecount==0){
                        ...
                        if($pageno==1){
                            ...
                            echo "<a href='receiveemail.php?pageno=1'>首页</a>&nbsp;&nbsp;";}
                        if($pageno==1){
                            echo "上页&nbsp;&nbsp;";}
                        else{
                        ...
                        if($pageno==$pagecount){
                            ...
                            echo "<a href='receiveemail.php?pageno=".($pageno+1)."'>下页</a>&nbsp;&nbsp;";}
                        if($pageno==$pagecount){
                            echo "尾页&nbsp;&nbsp;";}
                        else{
                            echo "<a href='receiveemail.php?pageno=".($pagecount)."'>尾页</a>&nbsp;&nbsp;";}
                    }
                ?>
            </div>
        </div>
